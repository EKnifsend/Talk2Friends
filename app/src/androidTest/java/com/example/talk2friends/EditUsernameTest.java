...
public class EditUsernameTest {
    ...
    public void editUsernameTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.username),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("william"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.username), withText("william"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView.check(matches(withText("william")));
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.username),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("will"), closeSoftKeyboard());
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.username), withText("will"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
